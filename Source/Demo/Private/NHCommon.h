	...
	namespace sdk {
		namespace demo {
			...
			const TArray<FAsset> ASSETS{
				...
				{ TEXT("SDK_blusher_F_NH01"),	TEXT("blusher_64a538157868363aa03260bb"), EGender::FEMALE, CATEGORY_MAKEUP_BLUSHER },
				{ TEXT("SDK_eyemakeup_F_NH01"),	TEXT("eyemakeup_64a5382a7868363aa03260bc"), EGender::FEMALE, CATEGORY_MAKEUP_EYE },
				{ TEXT("SDK_lipstick_F_NH01"),	TEXT("lipstick_64a538407868363aa03260bd"), EGender::FEMALE, CATEGORY_MAKEUP_LIP },
				...
				{ TEXT("SDK_blusher_M_NH01"),	TEXT("blusher_64a538587868363aa03260be"),  EGender::MALE, CATEGORY_MAKEUP_BLUSHER },
				{ TEXT("SDK_eyemakeup_M_NH01"),	TEXT("eyemakeup_64a5386a7868363aa03260bf"),  EGender::MALE, CATEGORY_MAKEUP_EYE },
				{ TEXT("SDK_lipstick_M_NH01"),	TEXT("lipstick_64a538787868363aa03260c0"),  EGender::MALE, CATEGORY_MAKEUP_LIP },
